  ...
  return (
    <>
      <PageHero
        ...
        intro="Short, practical reads on the technology decisions SMB owners actually face — written to be useful before you ever talk to us."
      />
      <section className="max-w-6xl mx-auto px-5 pb-16 md:pb-24">
          ...
          {POSTS.map((p) => (
            <article key={p.title} className="card-static rounded-lg p-6 md:p-7 flex flex-col">
              <div className="flex items-center justify-between">
                <span className="f-mono text-xs c-blue tracking-widest">{p.tag}</span>
        ...
        <div className="card-static rounded-lg p-6 mt-6" style={{ background: "#EEF2F8" }}>
