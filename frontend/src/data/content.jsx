...
export const SERVICES = [
  {
    ...
    image: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=900&q=75",
    imageAlt: "A laptop glowing with color in a dark room, mid AI workflow",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=900&q=75",
    imageAlt: "A code editor showing a syntax-highlighted application on a laptop screen",
    heroLine: "Software you own, built to outlast us.",
    intro: "We design and ship web and mobile applications from first wireframe to production, and we build them so that any competent developer after us can pick up the codebase without a treasure map.",
    offerings: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=900&q=75",
    imageAlt: "Hands working across laptops and notes, mapping a process",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=900&q=75",
    imageAlt: "City lights seen from orbit at night, a network spanning the globe",
    heroLine: "Infrastructure that's boring, in exactly the way you want it to be.",
    ...
    offerings: [
      { name: "Cloud migration", body: "Planned, rehearsed moves from on-premise or aging hosts to modern cloud infrastructure, with rollback plans instead of crossed fingers." },
...
export const CASES = [
  {
    ...
    imageAlt: "A restaurant dining room, the kind of floor plan compliance software has to track",
  },
  {
    industry: "B2B SALES",
    ...
    imageAlt: "A hand reviewing outbound sales data on a laptop screen",
  },
  {
    ...
    imageAlt: "Two colleagues reviewing a shipped feature over a laptop",
  },
  {
    industry: "HEALTHCARE",
    ...
    imageAlt: "A clinician checking messages on a phone, stethoscope around their neck",
  },
  {
    industry: "LOGISTICS",
    ...
    imageAlt: "A freight truck on the highway mid-delivery route",
  },
  {
    industry: "E-COMMERCE",
    ...
    imageAlt: "A card tapped to a retail checkout reader",
  },
  {
    industry: "LEGAL",
    ...
    image: "https://images.unsplash.com/photo-1479142506502-19b3a3b7ff33?auto=format&fit=crop&w=1200&q=70",
    imageAlt: "A shelf of bound legal volumes in a law office",
  },
];
...
export const POSTS = [
  {
    ...
    date: "June 10, 2026",
    readTime: "5 min read",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=900&q=75",
    imageAlt: "Server racks wired for a cloud migration",
...
If the proposal in front of you looks suspiciously clean, ask which of these it includes. The answer tells you a lot about who wrote it.`,
  },
  {
    ...
    imageAlt: "A team mapping a workflow on sticky notes",
...
Hype has grand answers. "It will transform how you engage customers." Vague is a feature for the seller: it's easy to promise and impossible to fail at. If nobody in the room can name the task, nobody will ever be able to say the project didn't work.
...
export const CONTACT = {
  email: "Yashk@pivotbridgetech.com",
